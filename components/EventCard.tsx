...
const EventCardComponent: React.FC<Props> = ({ event, onSelect }) => {
      ...
      <div className="relative h-48 w-full overflow-hidden bg-navy-950 flex items-center justify-center">
        ...
        <div className="absolute top-3 right-3 z-10 flex gap-2">
           ...
           {event.isCommunityEvent && (
             <span className="px-2 py-1 rounded text-xs font-bold uppercase tracking-wide bg-orange-500/90 text-white border border-orange-400/50 flex items-center gap-1 shadow-sm">
