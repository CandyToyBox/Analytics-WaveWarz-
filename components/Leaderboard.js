...
var Leaderboard = function (_a) {
    var artists = _a.artists, totalBattles = _a.totalBattles;
      ...
      <div className="bg-navy-800 border border-navy-700 rounded-2xl overflow-hidden">
        <div className="p-6 border-b border-navy-700 flex justify-between items-center">
          <h3 className="text-lg font-bold text-white flex items-center gap-2">
            <lucide_react_1.Trophy className="text-yellow-500" size={20}/>
            Most Active Artists
          </h3>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="text-sm divide-y divide-navy-700">
              {artists.map(function (artist, index) { return (<tr key={artist.name} className="hover:bg-navy-700 transition-colors">
                  <td className="p-4">
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-navy-900 overflow-hidden border border-navy-700">
                        <img src={artist.avatar} alt={artist.name} className="w-full h-full object-cover" onError={function (e) {
